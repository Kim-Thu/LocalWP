...
## Dependency bắt buộc
- `T0001` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-desktop-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create Desktop project** theo BRD, SRS và kiến trúc hiện hành.
...
## Acceptance criteria
- [x] Desktop project tồn tại trong `src/LocalWP.Desktop`.
