# T0002 — Validate repository metadata
...
## Branch bắt buộc
`maint/validate-repository-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate repository metadata** theo BRD, SRS và kiến trúc hiện hành.
