# T0005 — Test repository metadata
...
## Branch bắt buộc
`maint/test-repository-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test repository metadata** theo BRD, SRS và kiến trúc hiện hành.
