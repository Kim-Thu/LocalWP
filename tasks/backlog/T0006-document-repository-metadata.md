# T0006 — Document repository metadata
...
## Branch bắt buộc
`maint/document-repository-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document repository metadata** theo BRD, SRS và kiến trúc hiện hành.
