# T0008 — Harden repository metadata
...
## Branch bắt buộc
`maint/harden-repository-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden repository metadata** theo BRD, SRS và kiến trúc hiện hành.
