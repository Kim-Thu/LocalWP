...
## Branch bắt buộc
`maint/validate-branch-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate branch policy** theo BRD, SRS và kiến trúc hiện hành.
