...
## Branch bắt buộc
`maint/implement-branch-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement branch policy** theo BRD, SRS và kiến trúc hiện hành.
