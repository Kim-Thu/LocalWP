...
## Branch bắt buộc
`maint/document-branch-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document branch policy** theo BRD, SRS và kiến trúc hiện hành.
