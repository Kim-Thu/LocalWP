...
## Branch bắt buộc
`maint/integrate-branch-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate branch policy** theo BRD, SRS và kiến trúc hiện hành.
