...
## Dependency bắt buộc
- `T0018` phải hoàn thành và merge.

## Branch bắt buộc
`feat/configure-editorconfig-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **configure EditorConfig** theo BRD, SRS và kiến trúc hiện hành.
