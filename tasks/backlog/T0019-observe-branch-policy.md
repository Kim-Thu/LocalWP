...
## Branch bắt buộc
`maint/observe-branch-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe branch policy** theo BRD, SRS và kiến trúc hiện hành.
