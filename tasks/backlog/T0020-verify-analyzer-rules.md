...
## Dependency bắt buộc
- `T0019` phải hoàn thành và merge.

## Branch bắt buộc
`feat/verify-analyzer-rules-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **verify analyzer rules** theo BRD, SRS và kiến trúc hiện hành.
