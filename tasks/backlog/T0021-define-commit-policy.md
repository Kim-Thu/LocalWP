...
## Dependency bắt buộc
- `T0020` phải hoàn thành và merge.

## Branch bắt buộc
`maint/define-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define commit policy** theo BRD, SRS và kiến trúc hiện hành.
