# T0022 — Install communitytoolkit.mvvm
...
## Dependency bắt buộc
- `T0021` phải hoàn thành và merge.

## Branch bắt buộc
`feat/install-communitytoolkit-mvvm-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **install CommunityToolkit.Mvvm** theo BRD, SRS và kiến trúc hiện hành.
