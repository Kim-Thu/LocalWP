...
## Branch bắt buộc
`maint/validate-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate commit policy** theo BRD, SRS và kiến trúc hiện hành.
