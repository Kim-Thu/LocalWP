...
## Dependency bắt buộc
- `T0022` phải hoàn thành và merge.

## Branch bắt buộc
`maint/model-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model commit policy** theo BRD, SRS và kiến trúc hiện hành.
