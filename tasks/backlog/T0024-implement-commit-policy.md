...
## Branch bắt buộc
`maint/implement-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement commit policy** theo BRD, SRS và kiến trúc hiện hành.
