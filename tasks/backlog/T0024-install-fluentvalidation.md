# T0024 — Install fluentvalidation
...
## Dependency bắt buộc
- `T0023` phải hoàn thành và merge.

## Branch bắt buộc
`feat/install-fluentvalidation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **install FluentValidation** theo BRD, SRS và kiến trúc hiện hành.
