...
## Dependency bắt buộc
- `T0024` phải hoàn thành và merge.

## Branch bắt buộc
`maint/test-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test commit policy** theo BRD, SRS và kiến trúc hiện hành.
