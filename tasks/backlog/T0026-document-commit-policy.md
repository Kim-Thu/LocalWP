...
## Dependency bắt buộc
- `T0025` phải hoàn thành và merge.

## Branch bắt buộc
`maint/document-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document commit policy** theo BRD, SRS và kiến trúc hiện hành.
