...
## Dependency bắt buộc
- `T0026` phải hoàn thành và merge.

## Branch bắt buộc
`maint/integrate-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate commit policy** theo BRD, SRS và kiến trúc hiện hành.
