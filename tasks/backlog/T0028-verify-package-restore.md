...
## Dependency bắt buộc
- `T0027` phải hoàn thành và merge.

## Branch bắt buộc
`feat/verify-package-restore-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **verify package restore** theo BRD, SRS và kiến trúc hiện hành.
