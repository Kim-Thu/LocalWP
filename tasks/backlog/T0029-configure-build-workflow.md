# T0029 — Configure build workflow
...
## Dependency bắt buộc
- `T0028` phải hoàn thành và merge.

## Branch bắt buộc
`feat/configure-build-workflow-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **configure build workflow** theo BRD, SRS và kiến trúc hiện hành.
