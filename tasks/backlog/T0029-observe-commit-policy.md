...
## Branch bắt buộc
`maint/observe-commit-policy-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe commit policy** theo BRD, SRS và kiến trúc hiện hành.
