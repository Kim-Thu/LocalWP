...
## Dependency bắt buộc
- `T0029` phải hoàn thành và merge.

## Branch bắt buộc
`feat/configure-test-workflow-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **configure test workflow** theo BRD, SRS và kiến trúc hiện hành.
