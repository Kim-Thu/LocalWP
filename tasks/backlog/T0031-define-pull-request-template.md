# T0031 — Define pull request template
...
## Dependency bắt buộc
- `T0030` phải hoàn thành và merge.

## Branch bắt buộc
`maint/define-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define pull request template** theo BRD, SRS và kiến trúc hiện hành.
