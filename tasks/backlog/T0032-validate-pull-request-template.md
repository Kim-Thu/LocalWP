# T0032 — Validate pull request template
...
## Dependency bắt buộc
- `T0031` phải hoàn thành và merge.

## Branch bắt buộc
`maint/validate-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate pull request template** theo BRD, SRS và kiến trúc hiện hành.
