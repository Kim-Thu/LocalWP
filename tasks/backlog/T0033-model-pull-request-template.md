# T0033 — Model pull request template
...
## Dependency bắt buộc
- `T0032` phải hoàn thành và merge.

## Branch bắt buộc
`maint/model-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model pull request template** theo BRD, SRS và kiến trúc hiện hành.
