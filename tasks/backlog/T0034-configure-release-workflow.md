# T0034 — Configure release workflow
...
## Branch bắt buộc
`feat/configure-release-workflow-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **configure release workflow** theo BRD, SRS và kiến trúc hiện hành.
