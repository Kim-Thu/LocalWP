# T0034 — Implement pull request template
...
## Dependency bắt buộc
- `T0033` phải hoàn thành và merge.

## Branch bắt buộc
`maint/implement-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement pull request template** theo BRD, SRS và kiến trúc hiện hành.
