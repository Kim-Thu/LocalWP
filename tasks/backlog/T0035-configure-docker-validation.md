# T0035 — Configure docker validation
...
## Dependency bắt buộc
- `T0034` phải hoàn thành và merge.

## Branch bắt buộc
`feat/configure-docker-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **configure Docker validation** theo BRD, SRS và kiến trúc hiện hành.
