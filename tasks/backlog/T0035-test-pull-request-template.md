# T0035 — Test pull request template
...
## Branch bắt buộc
`maint/test-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test pull request template** theo BRD, SRS và kiến trúc hiện hành.
