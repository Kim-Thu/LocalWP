# T0036 — Document pull request template
...
## Dependency bắt buộc
- `T0035` phải hoàn thành và merge.

## Branch bắt buộc
`maint/document-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document pull request template** theo BRD, SRS và kiến trúc hiện hành.
