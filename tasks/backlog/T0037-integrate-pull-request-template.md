# T0037 — Integrate pull request template
...
## Dependency bắt buộc
- `T0036` phải hoàn thành và merge.

## Branch bắt buộc
`maint/integrate-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate pull request template** theo BRD, SRS và kiến trúc hiện hành.
