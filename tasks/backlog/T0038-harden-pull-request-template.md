# T0038 — Harden pull request template
...
## Dependency bắt buộc
- `T0037` phải hoàn thành và merge.

## Branch bắt buộc
`maint/harden-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden pull request template** theo BRD, SRS và kiến trúc hiện hành.
