# T0039 — Observe pull request template
...
## Dependency bắt buộc
- `T0038` phải hoàn thành và merge.

## Branch bắt buộc
`maint/observe-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe pull request template** theo BRD, SRS và kiến trúc hiện hành.
