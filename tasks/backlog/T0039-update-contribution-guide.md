# T0039 — Update contribution guide
...
## Branch bắt buộc
`feat/update-contribution-guide-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **update contribution guide** theo BRD, SRS và kiến trúc hiện hành.
