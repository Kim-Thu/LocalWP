# T0040 — Review pull request template
...
## Dependency bắt buộc
- `T0039` phải hoàn thành và merge.

## Branch bắt buộc
`maint/review-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review pull request template** theo BRD, SRS và kiến trúc hiện hành.
