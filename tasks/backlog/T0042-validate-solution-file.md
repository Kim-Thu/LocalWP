...
## Branch bắt buộc
`feat/validate-solution-file-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate solution file** theo BRD, SRS và kiến trúc hiện hành.
