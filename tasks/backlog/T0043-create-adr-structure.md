...
## Dependency bắt buộc
- `T0042` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-adr-structure-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create ADR structure** theo BRD, SRS và kiến trúc hiện hành.
