...
## Dependency bắt buộc
- `T0051` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-assets-folder-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create assets folder** theo BRD, SRS và kiến trúc hiện hành.
