...
## Dependency bắt buộc
- `T0052` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-scripts-folder-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create scripts folder** theo BRD, SRS và kiến trúc hiện hành.
