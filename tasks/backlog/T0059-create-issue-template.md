...
## Dependency bắt buộc
- `T0058` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-issue-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create issue template** theo BRD, SRS và kiến trúc hiện hành.
