...
## Dependency bắt buộc
- `T0059` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-bug-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create bug template** theo BRD, SRS và kiến trúc hiện hành.
