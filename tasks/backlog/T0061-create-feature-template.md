...
## Dependency bắt buộc
- `T0060` phải hoàn thành và merge.

## Branch bắt buộc
`feat/create-feature-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **create feature template** theo BRD, SRS và kiến trúc hiện hành.
