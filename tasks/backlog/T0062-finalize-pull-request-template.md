# T0062 — Finalize pull request template
...
## Dependency bắt buộc
- `T0061` phải hoàn thành và merge.

## Branch bắt buộc
`feat/finalize-pull-request-template-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **finalize pull request template** theo BRD, SRS và kiến trúc hiện hành.
