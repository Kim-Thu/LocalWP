# T0066 — Write branch protection checklist
...
## Dependency bắt buộc
- `T0065` phải hoàn thành và merge.

## Branch bắt buộc
`feat/write-branch-protection-checklist-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **write branch protection checklist** theo BRD, SRS và kiến trúc hiện hành.
