...
## Dependency bắt buộc
- `T0067` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-build-properties-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden build properties** theo BRD, SRS và kiến trúc hiện hành.
