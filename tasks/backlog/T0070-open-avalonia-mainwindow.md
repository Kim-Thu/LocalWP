# T0070 — Open avalonia mainwindow
...
## Dependency bắt buộc
- `T0069` phải hoàn thành và merge.

## Branch bắt buộc
`feat/open-avalonia-mainwindow-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **open Avalonia MainWindow** theo BRD, SRS và kiến trúc hiện hành.
