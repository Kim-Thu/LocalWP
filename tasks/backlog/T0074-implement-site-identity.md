...
## Branch bắt buộc
`feat/implement-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement site identity** theo BRD, SRS và kiến trúc hiện hành.
