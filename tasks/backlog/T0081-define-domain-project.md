...
## Dependency bắt buộc
- `T0080` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define domain project** theo BRD, SRS và kiến trúc hiện hành.
