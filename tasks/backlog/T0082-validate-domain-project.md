...
## Dependency bắt buộc
- `T0081` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate domain project** theo BRD, SRS và kiến trúc hiện hành.
