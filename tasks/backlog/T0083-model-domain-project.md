...
## Dependency bắt buộc
- `T0082` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model domain project** theo BRD, SRS và kiến trúc hiện hành.
