# T0084 — Implement domain project
...
## Dependency bắt buộc
- `T0083` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement domain project** theo BRD, SRS và kiến trúc hiện hành.
