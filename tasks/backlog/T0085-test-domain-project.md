...
## Dependency bắt buộc
- `T0084` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test domain project** theo BRD, SRS và kiến trúc hiện hành.
