...
## Dependency bắt buộc
- `T0085` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document domain project** theo BRD, SRS và kiến trúc hiện hành.
