# T0087 — Integrate domain project
...
## Dependency bắt buộc
- `T0086` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate domain project** theo BRD, SRS và kiến trúc hiện hành.
