...
## Dependency bắt buộc
- `T0087` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden domain project** theo BRD, SRS và kiến trúc hiện hành.
