...
## Dependency bắt buộc
- `T0089` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-domain-project-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review domain project** theo BRD, SRS và kiến trúc hiện hành.
