...
## Dependency bắt buộc
- `T0090` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site identity** theo BRD, SRS và kiến trúc hiện hành.
