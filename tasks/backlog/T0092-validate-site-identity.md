...
## Dependency bắt buộc
- `T0091` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate site identity** theo BRD, SRS và kiến trúc hiện hành.
