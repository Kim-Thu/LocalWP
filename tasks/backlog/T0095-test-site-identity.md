...
## Dependency bắt buộc
- `T0094` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test site identity** theo BRD, SRS và kiến trúc hiện hành.
