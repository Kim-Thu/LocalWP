...
## Dependency bắt buộc
- `T0095` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document site identity** theo BRD, SRS và kiến trúc hiện hành.
