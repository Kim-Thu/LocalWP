...
## Dependency bắt buộc
- `T0096` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate site identity** theo BRD, SRS và kiến trúc hiện hành.
