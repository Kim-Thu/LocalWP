...
## Dependency bắt buộc
- `T0097` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden site identity** theo BRD, SRS và kiến trúc hiện hành.
