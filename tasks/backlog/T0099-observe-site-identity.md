...
## Dependency bắt buộc
- `T0098` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe site identity** theo BRD, SRS và kiến trúc hiện hành.
