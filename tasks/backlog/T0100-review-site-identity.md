...
## Dependency bắt buộc
- `T0099` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review site identity** theo BRD, SRS và kiến trúc hiện hành.
