...
## Dependency bắt buộc
- `T0100` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-runtime-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define runtime state** theo BRD, SRS và kiến trúc hiện hành.
