...
## Dependency bắt buộc
- `T0101` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-runtime-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate runtime state** theo BRD, SRS và kiến trúc hiện hành.
