...
## Dependency bắt buộc
- `T0107` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-runtime-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden runtime state** theo BRD, SRS và kiến trúc hiện hành.
