# T0120 — Review environment config
...
## Dependency bắt buộc
- `T0119` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-environment-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review environment config** theo BRD, SRS và kiến trúc hiện hành.
