...
## Dependency bắt buộc
- `T0120` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define WordPress config** theo BRD, SRS và kiến trúc hiện hành.
