...
## Dependency bắt buộc
- `T0122` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model WordPress config** theo BRD, SRS và kiến trúc hiện hành.
