# T0124 — Implement wordpress config
...
## Dependency bắt buộc
- `T0123` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement WordPress config** theo BRD, SRS và kiến trúc hiện hành.
