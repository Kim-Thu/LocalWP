# T0126 — Document wordpress config
...
## Dependency bắt buộc
- `T0125` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document WordPress config** theo BRD, SRS và kiến trúc hiện hành.
