...
## Dependency bắt buộc
- `T0129` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review WordPress config** theo BRD, SRS và kiến trúc hiện hành.
