...
## Branch bắt buộc
`feat/define-database-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define database config** theo BRD, SRS và kiến trúc hiện hành.
