# T0132 — Validate environment config
...
## Dependency bắt buộc
- `T0131` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-environment-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate environment config** theo BRD, SRS và kiến trúc hiện hành.
