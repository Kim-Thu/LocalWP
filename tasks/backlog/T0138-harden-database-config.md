...
## Branch bắt buộc
`feat/harden-database-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden database config** theo BRD, SRS và kiến trúc hiện hành.
