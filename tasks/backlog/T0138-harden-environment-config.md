# T0138 — Harden environment config
...
## Dependency bắt buộc
- `T0137` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-environment-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden environment config** theo BRD, SRS và kiến trúc hiện hành.
