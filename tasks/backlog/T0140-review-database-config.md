...
## Branch bắt buộc
`feat/review-database-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review database config** theo BRD, SRS và kiến trúc hiện hành.
