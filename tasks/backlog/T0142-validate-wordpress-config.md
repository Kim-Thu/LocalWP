# T0142 — Validate wordpress config
...
## Dependency bắt buộc
- `T0141` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate WordPress config** theo BRD, SRS và kiến trúc hiện hành.
