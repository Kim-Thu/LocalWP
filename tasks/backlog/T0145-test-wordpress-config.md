...
## Dependency bắt buộc
- `T0144` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test WordPress config** theo BRD, SRS và kiến trúc hiện hành.
