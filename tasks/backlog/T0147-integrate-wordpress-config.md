# T0147 — Integrate wordpress config
...
## Dependency bắt buộc
- `T0146` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate WordPress config** theo BRD, SRS và kiến trúc hiện hành.
