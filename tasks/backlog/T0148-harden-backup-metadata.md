...
## Branch bắt buộc
`feat/harden-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden backup metadata** theo BRD, SRS và kiến trúc hiện hành.
