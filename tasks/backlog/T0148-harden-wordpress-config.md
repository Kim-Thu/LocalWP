...
## Dependency bắt buộc
- `T0147` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-wordpress-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden WordPress config** theo BRD, SRS và kiến trúc hiện hành.
