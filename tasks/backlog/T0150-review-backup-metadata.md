...
## Branch bắt buộc
`feat/review-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review backup metadata** theo BRD, SRS và kiến trúc hiện hành.
