# T0152 — Validate database config
...
## Branch bắt buộc
`feat/validate-database-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate database config** theo BRD, SRS và kiến trúc hiện hành.
