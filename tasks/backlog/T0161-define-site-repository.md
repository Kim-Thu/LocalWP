...
## Dependency bắt buộc
- `T0160` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site repository** theo BRD, SRS và kiến trúc hiện hành.
