# T0162 — Validate site repository
...
## Dependency bắt buộc
- `T0161` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate site repository** theo BRD, SRS và kiến trúc hiện hành.
