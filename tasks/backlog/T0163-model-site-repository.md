...
## Dependency bắt buộc
- `T0162` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model site repository** theo BRD, SRS và kiến trúc hiện hành.
