...
## Dependency bắt buộc
- `T0164` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test site repository** theo BRD, SRS và kiến trúc hiện hành.
