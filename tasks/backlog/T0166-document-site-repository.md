# T0166 — Document site repository
...
## Dependency bắt buộc
- `T0165` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document site repository** theo BRD, SRS và kiến trúc hiện hành.
