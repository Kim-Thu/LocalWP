# T0167 — Integrate site repository
...
## Dependency bắt buộc
- `T0166` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate site repository** theo BRD, SRS và kiến trúc hiện hành.
