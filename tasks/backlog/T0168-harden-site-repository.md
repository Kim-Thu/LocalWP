...
## Dependency bắt buộc
- `T0167` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-site-repository-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden site repository** theo BRD, SRS và kiến trúc hiện hành.
