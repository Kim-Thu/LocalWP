# T0181 — Define atomic json write
...
## Dependency bắt buộc
- `T0180` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-atomic-json-write-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define atomic JSON write** theo BRD, SRS và kiến trúc hiện hành.
