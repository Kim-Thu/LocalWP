...
## Dependency bắt buộc
- `T0182` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-atomic-json-write-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model atomic JSON write** theo BRD, SRS và kiến trúc hiện hành.
