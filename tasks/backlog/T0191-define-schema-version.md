...
## Dependency bắt buộc
- `T0190` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define schema version** theo BRD, SRS và kiến trúc hiện hành.
