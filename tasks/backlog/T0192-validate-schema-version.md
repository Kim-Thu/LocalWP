...
## Dependency bắt buộc
- `T0191` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate schema version** theo BRD, SRS và kiến trúc hiện hành.
