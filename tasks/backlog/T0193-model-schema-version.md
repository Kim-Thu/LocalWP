...
## Dependency bắt buộc
- `T0192` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model schema version** theo BRD, SRS và kiến trúc hiện hành.
