# T0194 — Implement schema version
...
## Dependency bắt buộc
- `T0193` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement schema version** theo BRD, SRS và kiến trúc hiện hành.
