...
## Dependency bắt buộc
- `T0194` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test schema version** theo BRD, SRS và kiến trúc hiện hành.
