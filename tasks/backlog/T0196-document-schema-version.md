...
## Dependency bắt buộc
- `T0195` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document schema version** theo BRD, SRS và kiến trúc hiện hành.
