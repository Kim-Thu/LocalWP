# T0197 — Integrate schema version
...
## Dependency bắt buộc
- `T0196` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate schema version** theo BRD, SRS và kiến trúc hiện hành.
