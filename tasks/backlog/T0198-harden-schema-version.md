...
## Dependency bắt buộc
- `T0197` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden schema version** theo BRD, SRS và kiến trúc hiện hành.
