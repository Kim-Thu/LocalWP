...
## Dependency bắt buộc
- `T0198` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe schema version** theo BRD, SRS và kiến trúc hiện hành.
