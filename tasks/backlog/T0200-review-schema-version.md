...
## Dependency bắt buộc
- `T0199` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-schema-version-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review schema version** theo BRD, SRS và kiến trúc hiện hành.
