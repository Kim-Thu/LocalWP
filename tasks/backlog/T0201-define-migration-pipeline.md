# T0201 — Define migration pipeline
...
## Dependency bắt buộc
- `T0200` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
