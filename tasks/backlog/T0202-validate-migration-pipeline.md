# T0202 — Validate migration pipeline
...
## Dependency bắt buộc
- `T0201` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
