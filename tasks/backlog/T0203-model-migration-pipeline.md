# T0203 — Model migration pipeline
...
## Dependency bắt buộc
- `T0202` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
