# T0204 — Implement migration pipeline
...
## Dependency bắt buộc
- `T0203` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
