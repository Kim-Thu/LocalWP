...
## Dependency bắt buộc
- `T0204` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
