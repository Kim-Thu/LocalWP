# T0206 — Document migration pipeline
...
## Dependency bắt buộc
- `T0205` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
