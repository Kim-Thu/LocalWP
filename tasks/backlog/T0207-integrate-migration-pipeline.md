# T0207 — Integrate migration pipeline
...
## Dependency bắt buộc
- `T0206` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
