# T0208 — Harden migration pipeline
...
## Dependency bắt buộc
- `T0207` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-migration-pipeline-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden migration pipeline** theo BRD, SRS và kiến trúc hiện hành.
