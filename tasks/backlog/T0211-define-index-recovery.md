...
## Dependency bắt buộc
- `T0210` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define index recovery** theo BRD, SRS và kiến trúc hiện hành.
