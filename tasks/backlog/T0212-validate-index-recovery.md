...
## Dependency bắt buộc
- `T0211` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate index recovery** theo BRD, SRS và kiến trúc hiện hành.
