...
## Dependency bắt buộc
- `T0212` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model index recovery** theo BRD, SRS và kiến trúc hiện hành.
