# T0214 — Implement index recovery
...
## Dependency bắt buộc
- `T0213` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement index recovery** theo BRD, SRS và kiến trúc hiện hành.
