...
## Dependency bắt buộc
- `T0214` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test index recovery** theo BRD, SRS và kiến trúc hiện hành.
