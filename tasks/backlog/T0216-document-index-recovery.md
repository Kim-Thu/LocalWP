...
## Dependency bắt buộc
- `T0215` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document index recovery** theo BRD, SRS và kiến trúc hiện hành.
