# T0217 — Integrate index recovery
...
## Dependency bắt buộc
- `T0216` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate index recovery** theo BRD, SRS và kiến trúc hiện hành.
