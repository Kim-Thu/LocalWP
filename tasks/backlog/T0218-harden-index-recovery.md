...
## Dependency bắt buộc
- `T0217` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden index recovery** theo BRD, SRS và kiến trúc hiện hành.
