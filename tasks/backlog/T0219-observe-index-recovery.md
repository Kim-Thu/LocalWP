...
## Dependency bắt buộc
- `T0218` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe index recovery** theo BRD, SRS và kiến trúc hiện hành.
