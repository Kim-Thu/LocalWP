...
## Dependency bắt buộc
- `T0219` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-index-recovery-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review index recovery** theo BRD, SRS và kiến trúc hiện hành.
