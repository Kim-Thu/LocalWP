...
## Dependency bắt buộc
- `T0220` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define path provider** theo BRD, SRS và kiến trúc hiện hành.
