...
## Dependency bắt buộc
- `T0221` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate path provider** theo BRD, SRS và kiến trúc hiện hành.
