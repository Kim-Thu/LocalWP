...
## Dependency bắt buộc
- `T0222` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model path provider** theo BRD, SRS và kiến trúc hiện hành.
