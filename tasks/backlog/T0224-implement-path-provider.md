...
## Dependency bắt buộc
- `T0223` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement path provider** theo BRD, SRS và kiến trúc hiện hành.
