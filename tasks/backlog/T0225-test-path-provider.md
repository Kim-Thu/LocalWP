...
## Dependency bắt buộc
- `T0224` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test path provider** theo BRD, SRS và kiến trúc hiện hành.
