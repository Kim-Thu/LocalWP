...
## Dependency bắt buộc
- `T0225` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document path provider** theo BRD, SRS và kiến trúc hiện hành.
