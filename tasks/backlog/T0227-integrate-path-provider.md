...
## Dependency bắt buộc
- `T0226` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate path provider** theo BRD, SRS và kiến trúc hiện hành.
