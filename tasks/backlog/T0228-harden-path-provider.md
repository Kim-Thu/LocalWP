...
## Dependency bắt buộc
- `T0227` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden path provider** theo BRD, SRS và kiến trúc hiện hành.
