...
## Dependency bắt buộc
- `T0228` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe path provider** theo BRD, SRS và kiến trúc hiện hành.
