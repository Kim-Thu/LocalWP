...
## Dependency bắt buộc
- `T0229` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-path-provider-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review path provider** theo BRD, SRS và kiến trúc hiện hành.
