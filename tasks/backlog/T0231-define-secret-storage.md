...
## Dependency bắt buộc
- `T0230` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-secret-storage-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define secret storage** theo BRD, SRS và kiến trúc hiện hành.
