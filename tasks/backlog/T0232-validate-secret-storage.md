...
## Dependency bắt buộc
- `T0231` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-secret-storage-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate secret storage** theo BRD, SRS và kiến trúc hiện hành.
