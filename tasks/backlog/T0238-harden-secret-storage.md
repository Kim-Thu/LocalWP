...
## Dependency bắt buộc
- `T0237` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-secret-storage-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden secret storage** theo BRD, SRS và kiến trúc hiện hành.
