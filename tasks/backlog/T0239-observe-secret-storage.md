...
## Dependency bắt buộc
- `T0238` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-secret-storage-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe secret storage** theo BRD, SRS và kiến trúc hiện hành.
