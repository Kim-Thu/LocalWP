# T0246 — Document configuration validation
...
## Dependency bắt buộc
- `T0245` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-configuration-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document configuration validation** theo BRD, SRS và kiến trúc hiện hành.
