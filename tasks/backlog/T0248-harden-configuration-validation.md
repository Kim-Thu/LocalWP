# T0248 — Harden configuration validation
...
## Dependency bắt buộc
- `T0247` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-configuration-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden configuration validation** theo BRD, SRS và kiến trúc hiện hành.
