...
## Dependency bắt buộc
- `T0251` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate main window** theo BRD, SRS và kiến trúc hiện hành.
