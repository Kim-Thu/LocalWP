...
## Dependency bắt buộc
- `T0252` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model main window** theo BRD, SRS và kiến trúc hiện hành.
