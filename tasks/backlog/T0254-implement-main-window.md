...
## Dependency bắt buộc
- `T0253` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement main window** theo BRD, SRS và kiến trúc hiện hành.
