...
## Dependency bắt buộc
- `T0254` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test main window** theo BRD, SRS và kiến trúc hiện hành.
