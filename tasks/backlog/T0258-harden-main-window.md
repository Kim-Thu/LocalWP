...
## Dependency bắt buộc
- `T0257` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden main window** theo BRD, SRS và kiến trúc hiện hành.
