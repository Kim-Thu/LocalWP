...
## Dependency bắt buộc
- `T0258` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-main-window-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe main window** theo BRD, SRS và kiến trúc hiện hành.
