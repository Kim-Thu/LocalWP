...
## Dependency bắt buộc
- `T0260` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-search-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site search** theo BRD, SRS và kiến trúc hiện hành.
