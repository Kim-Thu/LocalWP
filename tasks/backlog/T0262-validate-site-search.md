...
## Dependency bắt buộc
- `T0261` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-site-search-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate site search** theo BRD, SRS và kiến trúc hiện hành.
