...
## Dependency bắt buộc
- `T0263` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-site-search-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement site search** theo BRD, SRS và kiến trúc hiện hành.
