...
## Dependency bắt buộc
- `T0264` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-site-search-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test site search** theo BRD, SRS và kiến trúc hiện hành.
