...
## Dependency bắt buộc
- `T0268` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-site-search-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe site search** theo BRD, SRS và kiến trúc hiện hành.
