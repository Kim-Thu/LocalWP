# T0278 — Harden navigation service
...
## Dependency bắt buộc
- `T0277` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden navigation service** theo BRD, SRS và kiến trúc hiện hành.
