...
## Dependency bắt buộc
- `T0280` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define dialog service** theo BRD, SRS và kiến trúc hiện hành.
