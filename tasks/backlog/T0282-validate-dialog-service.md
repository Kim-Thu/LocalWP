...
## Dependency bắt buộc
- `T0281` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate dialog service** theo BRD, SRS và kiến trúc hiện hành.
