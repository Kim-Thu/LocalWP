...
## Dependency bắt buộc
- `T0282` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model dialog service** theo BRD, SRS và kiến trúc hiện hành.
