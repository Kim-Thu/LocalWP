# T0284 — Implement dialog service
...
## Dependency bắt buộc
- `T0283` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement dialog service** theo BRD, SRS và kiến trúc hiện hành.
