...
## Dependency bắt buộc
- `T0285` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document dialog service** theo BRD, SRS và kiến trúc hiện hành.
