# T0287 — Integrate dialog service
...
## Dependency bắt buộc
- `T0286` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate dialog service** theo BRD, SRS và kiến trúc hiện hành.
