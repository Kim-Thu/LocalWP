...
## Dependency bắt buộc
- `T0288` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-dialog-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe dialog service** theo BRD, SRS và kiến trúc hiện hành.
