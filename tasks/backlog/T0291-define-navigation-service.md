# T0291 — Define navigation service
...
## Dependency bắt buộc
- `T0290` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define navigation service** theo BRD, SRS và kiến trúc hiện hành.
