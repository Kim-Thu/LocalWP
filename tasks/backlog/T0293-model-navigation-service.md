# T0293 — Model navigation service
...
## Dependency bắt buộc
- `T0292` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model navigation service** theo BRD, SRS và kiến trúc hiện hành.
