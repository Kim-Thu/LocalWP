...
## Dependency bắt buộc
- `T0294` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test navigation service** theo BRD, SRS và kiến trúc hiện hành.
