# T0297 — Integrate navigation service
...
## Dependency bắt buộc
- `T0296` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate navigation service** theo BRD, SRS và kiến trúc hiện hành.
