# T0299 — Observe navigation service
...
## Dependency bắt buộc
- `T0298` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe navigation service** theo BRD, SRS và kiến trúc hiện hành.
