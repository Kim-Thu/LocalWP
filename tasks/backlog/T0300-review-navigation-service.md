# T0300 — Review navigation service
...
## Dependency bắt buộc
- `T0299` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-navigation-service-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review navigation service** theo BRD, SRS và kiến trúc hiện hành.
