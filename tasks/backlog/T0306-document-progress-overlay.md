# T0306 — Document progress overlay
...
## Dependency bắt buộc
- `T0305` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-progress-overlay-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document progress overlay** theo BRD, SRS và kiến trúc hiện hành.
