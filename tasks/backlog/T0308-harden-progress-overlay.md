...
## Dependency bắt buộc
- `T0307` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-progress-overlay-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden progress overlay** theo BRD, SRS và kiến trúc hiện hành.
