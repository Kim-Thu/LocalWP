...
## Dependency bắt buộc
- `T0310` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define theme resources** theo BRD, SRS và kiến trúc hiện hành.
