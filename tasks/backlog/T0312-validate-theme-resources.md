# T0312 — Validate theme resources
...
## Dependency bắt buộc
- `T0311` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate theme resources** theo BRD, SRS và kiến trúc hiện hành.
