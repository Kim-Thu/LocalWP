...
## Dependency bắt buộc
- `T0314` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test theme resources** theo BRD, SRS và kiến trúc hiện hành.
