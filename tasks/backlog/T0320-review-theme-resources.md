...
## Dependency bắt buộc
- `T0319` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review theme resources** theo BRD, SRS và kiến trúc hiện hành.
