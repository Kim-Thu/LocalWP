...
## Dependency bắt buộc
- `T0320` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-progress-overlay-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define progress overlay** theo BRD, SRS và kiến trúc hiện hành.
