...
## Dependency bắt buộc
- `T0329` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-progress-overlay-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review progress overlay** theo BRD, SRS và kiến trúc hiện hành.
