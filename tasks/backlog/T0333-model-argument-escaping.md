...
## Dependency bắt buộc
- `T0332` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-argument-escaping-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model argument escaping** theo BRD, SRS và kiến trúc hiện hành.
