...
## Branch bắt buộc
`feat/harden-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden theme resources** theo BRD, SRS và kiến trúc hiện hành.
