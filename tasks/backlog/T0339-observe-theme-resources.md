...
## Branch bắt buộc
`feat/observe-theme-resources-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe theme resources** theo BRD, SRS và kiến trúc hiện hành.
