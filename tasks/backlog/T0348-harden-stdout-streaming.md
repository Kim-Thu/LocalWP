...
## Dependency bắt buộc
- `T0347` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-stdout-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden stdout streaming** theo BRD, SRS và kiến trúc hiện hành.
