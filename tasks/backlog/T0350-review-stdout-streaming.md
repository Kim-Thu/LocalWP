...
## Dependency bắt buộc
- `T0349` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-stdout-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review stdout streaming** theo BRD, SRS và kiến trúc hiện hành.
