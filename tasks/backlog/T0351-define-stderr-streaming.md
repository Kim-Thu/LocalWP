...
## Branch bắt buộc
`feat/define-stderr-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define stderr streaming** theo BRD, SRS và kiến trúc hiện hành.
