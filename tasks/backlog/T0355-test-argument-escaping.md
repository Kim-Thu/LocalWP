...
## Dependency bắt buộc
- `T0354` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-argument-escaping-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test argument escaping** theo BRD, SRS và kiến trúc hiện hành.
