# T0358 — Harden argument escaping
...
## Dependency bắt buộc
- `T0357` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-argument-escaping-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden argument escaping** theo BRD, SRS và kiến trúc hiện hành.
