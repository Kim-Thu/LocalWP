...
## Dependency bắt buộc
- `T0362` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-stdout-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model stdout streaming** theo BRD, SRS và kiến trúc hiện hành.
