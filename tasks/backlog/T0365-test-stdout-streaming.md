...
## Dependency bắt buộc
- `T0364` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-stdout-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test stdout streaming** theo BRD, SRS và kiến trúc hiện hành.
