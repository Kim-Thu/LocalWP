# T0372 — Validate stderr streaming
...
## Dependency bắt buộc
- `T0371` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-stderr-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate stderr streaming** theo BRD, SRS và kiến trúc hiện hành.
