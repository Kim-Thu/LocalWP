...
## Dependency bắt buộc
- `T0379` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-stderr-streaming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review stderr streaming** theo BRD, SRS và kiến trúc hiện hành.
