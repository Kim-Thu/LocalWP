...
## Dependency bắt buộc
- `T0380` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-secret-redaction-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define secret redaction** theo BRD, SRS và kiến trúc hiện hành.
