# T0382 — Validate secret redaction
...
## Dependency bắt buộc
- `T0381` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-secret-redaction-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate secret redaction** theo BRD, SRS và kiến trúc hiện hành.
