# T0386 — Document secret redaction
...
## Dependency bắt buộc
- `T0385` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-secret-redaction-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document secret redaction** theo BRD, SRS và kiến trúc hiện hành.
