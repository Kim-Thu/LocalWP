...
## Branch bắt buộc
`feat/integrate-cancellation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate cancellation** theo BRD, SRS và kiến trúc hiện hành.
