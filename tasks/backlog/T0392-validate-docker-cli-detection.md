# T0392 — Validate docker cli detection
...
## Dependency bắt buộc
- `T0391` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
