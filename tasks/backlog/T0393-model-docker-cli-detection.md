# T0393 — Model docker cli detection
...
## Dependency bắt buộc
- `T0392` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
