# T0394 — Implement docker cli detection
...
## Dependency bắt buộc
- `T0393` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
