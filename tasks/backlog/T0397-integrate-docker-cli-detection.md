# T0397 — Integrate docker cli detection
...
## Dependency bắt buộc
- `T0396` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
