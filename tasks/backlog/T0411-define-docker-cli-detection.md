# T0411 — Define docker cli detection
...
## Dependency bắt buộc
- `T0410` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
