# T0418 — Harden docker cli detection
...
## Dependency bắt buộc
- `T0417` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-docker-cli-detection-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden Docker CLI detection** theo BRD, SRS và kiến trúc hiện hành.
