...
## Branch bắt buộc
`feat/validate-image-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate image catalog** theo BRD, SRS và kiến trúc hiện hành.
