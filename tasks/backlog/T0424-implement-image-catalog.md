...
## Branch bắt buộc
`feat/implement-image-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement image catalog** theo BRD, SRS và kiến trúc hiện hành.
