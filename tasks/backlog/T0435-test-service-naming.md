...
## Dependency bắt buộc
- `T0434` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-service-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test service naming** theo BRD, SRS và kiến trúc hiện hành.
