...
## Dependency bắt buộc
- `T0441` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-network-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate network naming** theo BRD, SRS và kiến trúc hiện hành.
