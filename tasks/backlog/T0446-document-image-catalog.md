...
## Branch bắt buộc
`feat/document-image-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document image catalog** theo BRD, SRS và kiến trúc hiện hành.
