...
## Branch bắt buộc
`feat/integrate-image-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate image catalog** theo BRD, SRS và kiến trúc hiện hành.
