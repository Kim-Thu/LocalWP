...
## Dependency bắt buộc
- `T0451` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-service-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate service naming** theo BRD, SRS và kiến trúc hiện hành.
