...
## Dependency bắt buộc
- `T0457` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-service-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden service naming** theo BRD, SRS và kiến trúc hiện hành.
