...
## Dependency bắt buộc
- `T0459` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-service-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review service naming** theo BRD, SRS và kiến trúc hiện hành.
