...
## Dependency bắt buộc
- `T0464` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-network-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test network naming** theo BRD, SRS và kiến trúc hiện hành.
