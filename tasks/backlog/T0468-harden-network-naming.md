...
## Dependency bắt buộc
- `T0467` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-network-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden network naming** theo BRD, SRS và kiến trúc hiện hành.
