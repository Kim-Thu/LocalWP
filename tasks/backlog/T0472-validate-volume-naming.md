...
## Dependency bắt buộc
- `T0471` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-volume-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate volume naming** theo BRD, SRS và kiến trúc hiện hành.
