...
## Dependency bắt buộc
- `T0474` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-volume-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test volume naming** theo BRD, SRS và kiến trúc hiện hành.
