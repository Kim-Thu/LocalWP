...
## Dependency bắt buộc
- `T0476` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-volume-naming-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate volume naming** theo BRD, SRS và kiến trúc hiện hành.
