...
## Dependency bắt buộc
- `T0482` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-database-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model database config** theo BRD, SRS và kiến trúc hiện hành.
