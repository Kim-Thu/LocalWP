...
## Branch bắt buộc
`feat/implement-nginx-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement Nginx config** theo BRD, SRS và kiến trúc hiện hành.
