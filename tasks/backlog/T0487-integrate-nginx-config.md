...
## Branch bắt buộc
`feat/integrate-nginx-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate Nginx config** theo BRD, SRS và kiến trúc hiện hành.
