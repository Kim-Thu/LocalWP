...
## Dependency bắt buộc
- `T0490` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-health-checks-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define health checks** theo BRD, SRS và kiến trúc hiện hành.
