...
## Dependency bắt buộc
- `T0496` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-health-checks-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate health checks** theo BRD, SRS và kiến trúc hiện hành.
