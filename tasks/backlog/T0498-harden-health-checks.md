...
## Dependency bắt buộc
- `T0497` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-health-checks-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden health checks** theo BRD, SRS và kiến trúc hiện hành.
