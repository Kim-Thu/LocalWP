...
## Dependency bắt buộc
- `T0498` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-health-checks-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe health checks** theo BRD, SRS và kiến trúc hiện hành.
