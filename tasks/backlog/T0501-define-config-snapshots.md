...
## Dependency bắt buộc
- `T0500` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-config-snapshots-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define config snapshots** theo BRD, SRS và kiến trúc hiện hành.
