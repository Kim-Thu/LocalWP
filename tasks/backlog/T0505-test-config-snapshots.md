...
## Dependency bắt buộc
- `T0504` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-config-snapshots-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test config snapshots** theo BRD, SRS và kiến trúc hiện hành.
