# T0515 — Test create-site request
...
## Dependency bắt buộc
- `T0514` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test create-site request** theo BRD, SRS và kiến trúc hiện hành.
