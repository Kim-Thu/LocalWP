# T0516 — Document create-site request
...
## Dependency bắt buộc
- `T0515` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document create-site request** theo BRD, SRS và kiến trúc hiện hành.
