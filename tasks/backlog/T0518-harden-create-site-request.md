# T0518 — Harden create-site request
...
## Dependency bắt buộc
- `T0517` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden create-site request** theo BRD, SRS và kiến trúc hiện hành.
