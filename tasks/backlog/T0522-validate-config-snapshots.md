# T0522 — Validate config snapshots
...
## Branch bắt buộc
`feat/validate-config-snapshots-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate config snapshots** theo BRD, SRS và kiến trúc hiện hành.
