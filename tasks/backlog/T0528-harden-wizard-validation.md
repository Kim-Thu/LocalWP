# T0528 — Harden wizard validation
...
## Dependency bắt buộc
- `T0527` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-wizard-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden wizard validation** theo BRD, SRS và kiến trúc hiện hành.
