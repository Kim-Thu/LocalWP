# T0532 — Validate create-site request
...
## Dependency bắt buộc
- `T0531` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate create-site request** theo BRD, SRS và kiến trúc hiện hành.
