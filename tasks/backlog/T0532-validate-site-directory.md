...
## Branch bắt buộc
`feat/validate-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate site directory** theo BRD, SRS và kiến trúc hiện hành.
