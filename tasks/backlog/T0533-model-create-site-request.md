# T0533 — Model create-site request
...
## Dependency bắt buộc
- `T0532` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model create-site request** theo BRD, SRS và kiến trúc hiện hành.
