...
## Branch bắt buộc
`feat/document-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document site directory** theo BRD, SRS và kiến trúc hiện hành.
