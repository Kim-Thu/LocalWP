# T0537 — Integrate create-site request
...
## Dependency bắt buộc
- `T0536` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-create-site-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate create-site request** theo BRD, SRS và kiến trúc hiện hành.
