...
## Branch bắt buộc
`feat/observe-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe site directory** theo BRD, SRS và kiến trúc hiện hành.
