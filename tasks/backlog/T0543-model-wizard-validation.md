...
## Dependency bắt buộc
- `T0542` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-wizard-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model wizard validation** theo BRD, SRS và kiến trúc hiện hành.
