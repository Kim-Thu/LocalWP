# T0544 — Implement wizard validation
...
## Branch bắt buộc
`feat/implement-wizard-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement wizard validation** theo BRD, SRS và kiến trúc hiện hành.
