...
## Dependency bắt buộc
- `T0544` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-wizard-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test wizard validation** theo BRD, SRS và kiến trúc hiện hành.
