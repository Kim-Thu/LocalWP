# T0550 — Review wizard validation
...
## Branch bắt buộc
`feat/review-wizard-validation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review wizard validation** theo BRD, SRS và kiến trúc hiện hành.
