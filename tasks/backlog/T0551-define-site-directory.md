...
## Dependency bắt buộc
- `T0550` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site directory** theo BRD, SRS và kiến trúc hiện hành.
