# T0554 — Implement site directory
...
## Dependency bắt buộc
- `T0553` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement site directory** theo BRD, SRS và kiến trúc hiện hành.
