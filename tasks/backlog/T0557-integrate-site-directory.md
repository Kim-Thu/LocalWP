# T0557 — Integrate site directory
...
## Dependency bắt buộc
- `T0556` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate site directory** theo BRD, SRS và kiến trúc hiện hành.
