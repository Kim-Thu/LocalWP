...
## Dependency bắt buộc
- `T0557` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-site-directory-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden site directory** theo BRD, SRS và kiến trúc hiện hành.
