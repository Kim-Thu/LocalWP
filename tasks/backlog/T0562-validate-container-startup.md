# T0562 — Validate container startup
...
## Branch bắt buộc
`feat/validate-container-startup-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate container startup** theo BRD, SRS và kiến trúc hiện hành.
