...
## Dependency bắt buộc
- `T0564` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-container-startup-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test container startup** theo BRD, SRS và kiến trúc hiện hành.
