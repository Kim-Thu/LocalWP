# T0566 — Document config generation
...
## Dependency bắt buộc
- `T0565` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-config-generation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document config generation** theo BRD, SRS và kiến trúc hiện hành.
