# T0578 — Harden database readiness
...
## Dependency bắt buộc
- `T0577` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-database-readiness-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden database readiness** theo BRD, SRS và kiến trúc hiện hành.
