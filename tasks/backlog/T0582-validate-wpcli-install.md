...
## Branch bắt buộc
`feat/validate-wpcli-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate WP-CLI install** theo BRD, SRS và kiến trúc hiện hành.
