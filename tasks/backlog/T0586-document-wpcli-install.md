...
## Branch bắt buộc
`feat/document-wpcli-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document WP-CLI install** theo BRD, SRS và kiến trúc hiện hành.
