...
## Dependency bắt buộc
- `T0594` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-database-readiness-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test database readiness** theo BRD, SRS và kiến trúc hiện hành.
