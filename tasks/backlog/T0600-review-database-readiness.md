# T0600 — Review database readiness
...
## Dependency bắt buộc
- `T0599` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-database-readiness-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review database readiness** theo BRD, SRS và kiến trúc hiện hành.
