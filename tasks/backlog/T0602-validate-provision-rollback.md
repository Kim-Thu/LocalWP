# T0602 — Validate provision rollback
...
## Dependency bắt buộc
- `T0601` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate provision rollback** theo BRD, SRS và kiến trúc hiện hành.
