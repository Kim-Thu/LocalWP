# T0604 — Implement provision rollback
...
## Dependency bắt buộc
- `T0603` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement provision rollback** theo BRD, SRS và kiến trúc hiện hành.
