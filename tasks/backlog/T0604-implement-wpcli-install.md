# T0604 — Implement wp-cli install
...
## Branch bắt buộc
`feat/implement-wpcli-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement WP-CLI install** theo BRD, SRS và kiến trúc hiện hành.
