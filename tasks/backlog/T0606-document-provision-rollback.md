# T0606 — Document provision rollback
...
## Dependency bắt buộc
- `T0605` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document provision rollback** theo BRD, SRS và kiến trúc hiện hành.
