# T0607 — Integrate wp-cli install
...
## Branch bắt buộc
`feat/integrate-wpcli-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate WP-CLI install** theo BRD, SRS và kiến trúc hiện hành.
