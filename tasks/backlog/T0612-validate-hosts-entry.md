...
## Branch bắt buộc
`security/validate-hosts-entry-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate hosts entry** theo BRD, SRS và kiến trúc hiện hành.
