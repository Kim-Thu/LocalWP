...
## Dependency bắt buộc
- `T0614` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-http-verification-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test HTTP verification** theo BRD, SRS và kiến trúc hiện hành.
