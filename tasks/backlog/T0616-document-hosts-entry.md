...
## Branch bắt buộc
`security/document-hosts-entry-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document hosts entry** theo BRD, SRS và kiến trúc hiện hành.
