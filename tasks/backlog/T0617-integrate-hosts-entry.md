...
## Branch bắt buộc
`security/integrate-hosts-entry-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate hosts entry** theo BRD, SRS và kiến trúc hiện hành.
