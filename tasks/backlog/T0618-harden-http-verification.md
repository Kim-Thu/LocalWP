# T0618 — Harden http verification
...
## Dependency bắt buộc
- `T0617` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-http-verification-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden HTTP verification** theo BRD, SRS và kiến trúc hiện hành.
