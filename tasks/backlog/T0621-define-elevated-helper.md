...
## Branch bắt buộc
`security/define-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define elevated helper** theo BRD, SRS và kiến trúc hiện hành.
