# T0621 — Define provision rollback
...
## Dependency bắt buộc
- `T0620` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define provision rollback** theo BRD, SRS và kiến trúc hiện hành.
