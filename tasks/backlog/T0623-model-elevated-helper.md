...
## Branch bắt buộc
`security/model-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model elevated helper** theo BRD, SRS và kiến trúc hiện hành.
