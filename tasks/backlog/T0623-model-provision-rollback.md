# T0623 — Model provision rollback
...
## Dependency bắt buộc
- `T0622` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model provision rollback** theo BRD, SRS và kiến trúc hiện hành.
