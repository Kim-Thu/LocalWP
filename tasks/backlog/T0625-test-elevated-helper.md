...
## Branch bắt buộc
`security/test-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test elevated helper** theo BRD, SRS và kiến trúc hiện hành.
