...
## Dependency bắt buộc
- `T0624` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test provision rollback** theo BRD, SRS và kiến trúc hiện hành.
