# T0627 — Integrate elevated helper
...
## Branch bắt buộc
`security/integrate-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate elevated helper** theo BRD, SRS và kiến trúc hiện hành.
