...
## Branch bắt buộc
`security/harden-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden elevated helper** theo BRD, SRS và kiến trúc hiện hành.
