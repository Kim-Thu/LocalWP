# T0628 — Harden provision rollback
...
## Dependency bắt buộc
- `T0627` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden provision rollback** theo BRD, SRS và kiến trúc hiện hành.
