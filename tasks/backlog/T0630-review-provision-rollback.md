# T0630 — Review provision rollback
...
## Dependency bắt buộc
- `T0629` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-provision-rollback-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review provision rollback** theo BRD, SRS và kiến trúc hiện hành.
