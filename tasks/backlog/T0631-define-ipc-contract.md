...
## Dependency bắt buộc
- `T0630` phải hoàn thành và merge.

## Branch bắt buộc
`security/define-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define IPC contract** theo BRD, SRS và kiến trúc hiện hành.
