...
## Dependency bắt buộc
- `T0631` phải hoàn thành và merge.

## Branch bắt buộc
`security/validate-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate IPC contract** theo BRD, SRS và kiến trúc hiện hành.
