...
## Dependency bắt buộc
- `T0632` phải hoàn thành và merge.

## Branch bắt buộc
`security/model-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model IPC contract** theo BRD, SRS và kiến trúc hiện hành.
