...
## Dependency bắt buộc
- `T0633` phải hoàn thành và merge.

## Branch bắt buộc
`security/implement-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement IPC contract** theo BRD, SRS và kiến trúc hiện hành.
