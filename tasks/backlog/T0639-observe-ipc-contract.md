...
## Dependency bắt buộc
- `T0638` phải hoàn thành và merge.

## Branch bắt buộc
`security/observe-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe IPC contract** theo BRD, SRS và kiến trúc hiện hành.
