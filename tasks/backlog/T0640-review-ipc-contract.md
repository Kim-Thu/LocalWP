...
## Dependency bắt buộc
- `T0639` phải hoàn thành và merge.

## Branch bắt buộc
`security/review-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review IPC contract** theo BRD, SRS và kiến trúc hiện hành.
