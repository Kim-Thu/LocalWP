# T0642 — Validate elevated helper
...
## Dependency bắt buộc
- `T0641` phải hoàn thành và merge.

## Branch bắt buộc
`security/validate-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate elevated helper** theo BRD, SRS và kiến trúc hiện hành.
