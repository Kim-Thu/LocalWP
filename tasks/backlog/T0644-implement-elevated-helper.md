# T0644 — Implement elevated helper
...
## Dependency bắt buộc
- `T0643` phải hoàn thành và merge.

## Branch bắt buộc
`security/implement-elevated-helper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement elevated helper** theo BRD, SRS và kiến trúc hiện hành.
