...
## Dependency bắt buộc
- `T0652` phải hoàn thành và merge.

## Branch bắt buộc
`security/model-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model certificate trust** theo BRD, SRS và kiến trúc hiện hành.
