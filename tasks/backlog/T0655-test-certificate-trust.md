...
## Dependency bắt buộc
- `T0654` phải hoàn thành và merge.

## Branch bắt buộc
`security/test-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test certificate trust** theo BRD, SRS và kiến trúc hiện hành.
