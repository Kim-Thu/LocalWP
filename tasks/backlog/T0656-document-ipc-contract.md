...
## Branch bắt buộc
`security/document-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document IPC contract** theo BRD, SRS và kiến trúc hiện hành.
