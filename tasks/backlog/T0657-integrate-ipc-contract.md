...
## Branch bắt buộc
`security/integrate-ipc-contract-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate IPC contract** theo BRD, SRS và kiến trúc hiện hành.
