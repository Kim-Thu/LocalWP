# T0661 — Define domain certificate
...
## Dependency bắt buộc
- `T0660` phải hoàn thành và merge.

## Branch bắt buộc
`security/define-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define domain certificate** theo BRD, SRS và kiến trúc hiện hành.
