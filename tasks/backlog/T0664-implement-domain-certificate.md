# T0664 — Implement domain certificate
...
## Dependency bắt buộc
- `T0663` phải hoàn thành và merge.

## Branch bắt buộc
`security/implement-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement domain certificate** theo BRD, SRS và kiến trúc hiện hành.
