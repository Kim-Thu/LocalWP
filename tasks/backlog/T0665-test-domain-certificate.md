...
## Dependency bắt buộc
- `T0664` phải hoàn thành và merge.

## Branch bắt buộc
`security/test-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test domain certificate** theo BRD, SRS và kiến trúc hiện hành.
