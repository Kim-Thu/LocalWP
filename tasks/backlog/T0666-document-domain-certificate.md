# T0666 — Document domain certificate
...
## Dependency bắt buộc
- `T0665` phải hoàn thành và merge.

## Branch bắt buộc
`security/document-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document domain certificate** theo BRD, SRS và kiến trúc hiện hành.
