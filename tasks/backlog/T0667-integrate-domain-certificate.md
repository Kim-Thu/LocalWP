# T0667 — Integrate domain certificate
...
## Dependency bắt buộc
- `T0666` phải hoàn thành và merge.

## Branch bắt buộc
`security/integrate-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate domain certificate** theo BRD, SRS và kiến trúc hiện hành.
