# T0670 — Review domain certificate
...
## Dependency bắt buộc
- `T0669` phải hoàn thành và merge.

## Branch bắt buộc
`security/review-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review domain certificate** theo BRD, SRS và kiến trúc hiện hành.
