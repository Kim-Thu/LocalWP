# T0671 — Define certificate trust
...
## Dependency bắt buộc
- `T0670` phải hoàn thành và merge.

## Branch bắt buộc
`security/define-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define certificate trust** theo BRD, SRS và kiến trúc hiện hành.
