# T0672 — Validate certificate trust
...
## Dependency bắt buộc
- `T0671` phải hoàn thành và merge.

## Branch bắt buộc
`security/validate-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate certificate trust** theo BRD, SRS và kiến trúc hiện hành.
