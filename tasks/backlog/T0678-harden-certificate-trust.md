# T0678 — Harden certificate trust
...
## Dependency bắt buộc
- `T0677` phải hoàn thành và merge.

## Branch bắt buộc
`security/harden-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden certificate trust** theo BRD, SRS và kiến trúc hiện hành.
