# T0680 — Review certificate trust
...
## Dependency bắt buộc
- `T0679` phải hoàn thành và merge.

## Branch bắt buộc
`security/review-certificate-trust-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review certificate trust** theo BRD, SRS và kiến trúc hiện hành.
