# T0682 — Validate domain certificate
...
## Dependency bắt buộc
- `T0681` phải hoàn thành và merge.

## Branch bắt buộc
`security/validate-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate domain certificate** theo BRD, SRS và kiến trúc hiện hành.
