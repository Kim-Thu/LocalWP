...
## Branch bắt buộc
`security/validate-trust-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate trust status** theo BRD, SRS và kiến trúc hiện hành.
