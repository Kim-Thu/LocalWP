# T0688 — Harden domain certificate
...
## Dependency bắt buộc
- `T0687` phải hoàn thành và merge.

## Branch bắt buộc
`security/harden-domain-certificate-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden domain certificate** theo BRD, SRS và kiến trúc hiện hành.
