...
## Dependency bắt buộc
- `T0695` phải hoàn thành và merge.

## Branch bắt buộc
`security/document-nginx-tls-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document Nginx TLS** theo BRD, SRS và kiến trúc hiện hành.
