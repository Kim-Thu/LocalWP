...
## Dependency bắt buộc
- `T0696` phải hoàn thành và merge.

## Branch bắt buộc
`security/integrate-nginx-tls-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate Nginx TLS** theo BRD, SRS và kiến trúc hiện hành.
