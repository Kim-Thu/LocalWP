...
## Dependency bắt buộc
- `T0699` phải hoàn thành và merge.

## Branch bắt buộc
`security/review-nginx-tls-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review Nginx TLS** theo BRD, SRS và kiến trúc hiện hành.
