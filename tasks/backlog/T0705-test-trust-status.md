...
## Dependency bắt buộc
- `T0704` phải hoàn thành và merge.

## Branch bắt buộc
`security/test-trust-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test trust status** theo BRD, SRS và kiến trúc hiện hành.
