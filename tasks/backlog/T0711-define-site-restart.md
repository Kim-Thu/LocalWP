...
## Dependency bắt buộc
- `T0710` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-restart-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site restart** theo BRD, SRS và kiến trúc hiện hành.
