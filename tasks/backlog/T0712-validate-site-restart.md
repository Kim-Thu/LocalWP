...
## Dependency bắt buộc
- `T0711` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-site-restart-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate site restart** theo BRD, SRS và kiến trúc hiện hành.
