...
## Dependency bắt buộc
- `T0713` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-site-restart-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement site restart** theo BRD, SRS và kiến trúc hiện hành.
