...
## Dependency bắt buộc
- `T0716` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-site-restart-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate site restart** theo BRD, SRS và kiến trúc hiện hành.
