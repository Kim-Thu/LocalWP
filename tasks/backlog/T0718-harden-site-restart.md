...
## Dependency bắt buộc
- `T0717` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-site-restart-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden site restart** theo BRD, SRS và kiến trúc hiện hành.
