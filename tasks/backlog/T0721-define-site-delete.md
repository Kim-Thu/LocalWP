...
## Dependency bắt buộc
- `T0720` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define site delete** theo BRD, SRS và kiến trúc hiện hành.
