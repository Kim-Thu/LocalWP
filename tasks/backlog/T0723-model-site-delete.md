...
## Dependency bắt buộc
- `T0722` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model site delete** theo BRD, SRS và kiến trúc hiện hành.
