...
## Dependency bắt buộc
- `T0723` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement site delete** theo BRD, SRS và kiến trúc hiện hành.
