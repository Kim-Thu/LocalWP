...
## Dependency bắt buộc
- `T0724` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test site delete** theo BRD, SRS và kiến trúc hiện hành.
