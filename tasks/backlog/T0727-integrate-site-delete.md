...
## Dependency bắt buộc
- `T0726` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate site delete** theo BRD, SRS và kiến trúc hiện hành.
