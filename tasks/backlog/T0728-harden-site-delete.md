...
## Dependency bắt buộc
- `T0727` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-site-delete-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden site delete** theo BRD, SRS và kiến trúc hiện hành.
