...
## Dependency bắt buộc
- `T0730` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-container-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define container status** theo BRD, SRS và kiến trúc hiện hành.
