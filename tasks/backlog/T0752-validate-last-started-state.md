# T0752 — Validate last-started state
...
## Dependency bắt buộc
- `T0751` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-last-started-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate last-started state** theo BRD, SRS và kiến trúc hiện hành.
