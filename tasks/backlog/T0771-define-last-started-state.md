# T0771 — Define last-started state
...
## Dependency bắt buộc
- `T0770` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-last-started-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define last-started state** theo BRD, SRS và kiến trúc hiện hành.
