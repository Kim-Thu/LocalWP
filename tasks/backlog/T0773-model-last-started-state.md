# T0773 — Model last-started state
...
## Dependency bắt buộc
- `T0772` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-last-started-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model last-started state** theo BRD, SRS và kiến trúc hiện hành.
