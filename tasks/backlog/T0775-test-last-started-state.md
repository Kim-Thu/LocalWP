...
## Dependency bắt buộc
- `T0774` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-last-started-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test last-started state** theo BRD, SRS và kiến trúc hiện hành.
