# T0779 — Observe last-started state
...
## Dependency bắt buộc
- `T0778` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-last-started-state-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe last-started state** theo BRD, SRS và kiến trúc hiện hành.
