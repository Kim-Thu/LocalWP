...
## Dependency bắt buộc
- `T0790` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define GZip import** theo BRD, SRS và kiến trúc hiện hành.
