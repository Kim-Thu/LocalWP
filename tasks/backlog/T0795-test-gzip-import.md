...
## Dependency bắt buộc
- `T0794` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test GZip import** theo BRD, SRS và kiến trúc hiện hành.
