...
## Dependency bắt buộc
- `T0795` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document GZip import** theo BRD, SRS và kiến trúc hiện hành.
