...
## Dependency bắt buộc
- `T0797` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden GZip import** theo BRD, SRS và kiến trúc hiện hành.
