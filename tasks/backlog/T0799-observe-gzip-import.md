...
## Dependency bắt buộc
- `T0798` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe GZip import** theo BRD, SRS và kiến trúc hiện hành.
