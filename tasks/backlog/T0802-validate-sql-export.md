...
## Dependency bắt buộc
- `T0801` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-sql-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate SQL export** theo BRD, SRS và kiến trúc hiện hành.
