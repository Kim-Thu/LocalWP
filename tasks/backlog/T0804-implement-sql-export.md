...
## Dependency bắt buộc
- `T0803` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-sql-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement SQL export** theo BRD, SRS và kiến trúc hiện hành.
