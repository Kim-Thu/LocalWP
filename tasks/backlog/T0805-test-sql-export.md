...
## Dependency bắt buộc
- `T0804` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-sql-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test SQL export** theo BRD, SRS và kiến trúc hiện hành.
