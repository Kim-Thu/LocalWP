...
## Dependency bắt buộc
- `T0806` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-sql-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate SQL export** theo BRD, SRS và kiến trúc hiện hành.
