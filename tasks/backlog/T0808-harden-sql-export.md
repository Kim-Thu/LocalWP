...
## Dependency bắt buộc
- `T0807` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-sql-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden SQL export** theo BRD, SRS và kiến trúc hiện hành.
