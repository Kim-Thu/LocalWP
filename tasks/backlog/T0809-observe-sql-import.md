...
## Dependency bắt buộc
- `T0808` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-sql-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe SQL import** theo BRD, SRS và kiến trúc hiện hành.
