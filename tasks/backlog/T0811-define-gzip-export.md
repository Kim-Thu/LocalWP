...
## Dependency bắt buộc
- `T0810` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define GZip export** theo BRD, SRS và kiến trúc hiện hành.
