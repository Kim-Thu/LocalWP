...
## Dependency bắt buộc
- `T0811` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate GZip export** theo BRD, SRS và kiến trúc hiện hành.
