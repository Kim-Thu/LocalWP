...
## Dependency bắt buộc
- `T0812` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-gzip-import-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model GZip import** theo BRD, SRS và kiến trúc hiện hành.
