...
## Dependency bắt buộc
- `T0814` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test GZip export** theo BRD, SRS và kiến trúc hiện hành.
