...
## Dependency bắt buộc
- `T0815` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document GZip export** theo BRD, SRS và kiến trúc hiện hành.
