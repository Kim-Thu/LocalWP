...
## Dependency bắt buộc
- `T0817` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden GZip export** theo BRD, SRS và kiến trúc hiện hành.
