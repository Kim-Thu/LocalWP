...
## Dependency bắt buộc
- `T0818` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-gzip-export-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe GZip export** theo BRD, SRS và kiến trúc hiện hành.
