...
## Dependency bắt buộc
- `T0820` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define database reset** theo BRD, SRS và kiến trúc hiện hành.
