...
## Dependency bắt buộc
- `T0821` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate database reset** theo BRD, SRS và kiến trúc hiện hành.
