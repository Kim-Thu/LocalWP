...
## Dependency bắt buộc
- `T0822` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model database reset** theo BRD, SRS và kiến trúc hiện hành.
