...
## Dependency bắt buộc
- `T0827` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden database reset** theo BRD, SRS và kiến trúc hiện hành.
