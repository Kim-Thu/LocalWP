...
## Dependency bắt buộc
- `T0829` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review database reset** theo BRD, SRS và kiến trúc hiện hành.
