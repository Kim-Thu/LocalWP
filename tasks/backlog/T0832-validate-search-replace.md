...
## Dependency bắt buộc
- `T0831` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate search replace** theo BRD, SRS và kiến trúc hiện hành.
