...
## Dependency bắt buộc
- `T0832` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model search replace** theo BRD, SRS và kiến trúc hiện hành.
