...
## Dependency bắt buộc
- `T0835` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document search replace** theo BRD, SRS và kiến trúc hiện hành.
