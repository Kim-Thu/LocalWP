# T0844 — Implement database reset
...
## Dependency bắt buộc
- `T0843` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement database reset** theo BRD, SRS và kiến trúc hiện hành.
