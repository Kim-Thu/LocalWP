# T0844 — Implement wp-cli wrapper
...
## Branch bắt buộc
`feat/implement-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
