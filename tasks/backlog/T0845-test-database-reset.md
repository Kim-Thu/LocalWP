...
## Dependency bắt buộc
- `T0844` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test database reset** theo BRD, SRS và kiến trúc hiện hành.
