...
## Dependency bắt buộc
- `T0845` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document database reset** theo BRD, SRS và kiến trúc hiện hành.
