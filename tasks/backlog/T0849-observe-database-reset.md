...
## Dependency bắt buộc
- `T0848` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-database-reset-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe database reset** theo BRD, SRS và kiến trúc hiện hành.
