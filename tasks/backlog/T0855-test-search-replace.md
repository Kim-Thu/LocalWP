...
## Dependency bắt buộc
- `T0854` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test search replace** theo BRD, SRS và kiến trúc hiện hành.
