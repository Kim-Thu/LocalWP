...
## Dependency bắt buộc
- `T0857` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden search replace** theo BRD, SRS và kiến trúc hiện hành.
