...
## Dependency bắt buộc
- `T0858` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-search-replace-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe search replace** theo BRD, SRS và kiến trúc hiện hành.
