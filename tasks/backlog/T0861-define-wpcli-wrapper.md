...
## Dependency bắt buộc
- `T0860` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
