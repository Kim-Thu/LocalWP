...
## Dependency bắt buộc
- `T0861` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
