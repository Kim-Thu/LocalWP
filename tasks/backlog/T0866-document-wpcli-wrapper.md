...
## Dependency bắt buộc
- `T0865` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
