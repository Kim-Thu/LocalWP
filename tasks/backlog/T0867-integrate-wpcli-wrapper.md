# T0867 — Integrate wp-cli wrapper
...
## Dependency bắt buộc
- `T0866` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
