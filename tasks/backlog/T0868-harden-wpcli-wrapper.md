...
## Dependency bắt buộc
- `T0867` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-wpcli-wrapper-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden WP-CLI wrapper** theo BRD, SRS và kiến trúc hiện hành.
