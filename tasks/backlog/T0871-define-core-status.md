...
## Dependency bắt buộc
- `T0870` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-core-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define core status** theo BRD, SRS và kiến trúc hiện hành.
