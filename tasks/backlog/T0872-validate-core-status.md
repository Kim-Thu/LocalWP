...
## Dependency bắt buộc
- `T0871` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-core-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate core status** theo BRD, SRS và kiến trúc hiện hành.
