...
## Dependency bắt buộc
- `T0872` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-core-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model core status** theo BRD, SRS và kiến trúc hiện hành.
