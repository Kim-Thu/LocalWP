...
## Dependency bắt buộc
- `T0874` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-plugin-list-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test plugin list** theo BRD, SRS và kiến trúc hiện hành.
