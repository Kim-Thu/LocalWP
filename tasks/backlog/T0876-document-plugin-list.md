...
## Dependency bắt buộc
- `T0875` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-plugin-list-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document plugin list** theo BRD, SRS và kiến trúc hiện hành.
