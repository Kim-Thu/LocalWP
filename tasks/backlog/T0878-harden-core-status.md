...
## Dependency bắt buộc
- `T0877` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-core-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden core status** theo BRD, SRS và kiến trúc hiện hành.
