...
## Dependency bắt buộc
- `T0879` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-core-status-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review core status** theo BRD, SRS và kiến trúc hiện hành.
