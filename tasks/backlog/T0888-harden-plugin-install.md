...
## Dependency bắt buộc
- `T0887` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden plugin install** theo BRD, SRS và kiến trúc hiện hành.
