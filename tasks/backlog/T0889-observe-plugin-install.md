...
## Dependency bắt buộc
- `T0888` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe plugin install** theo BRD, SRS và kiến trúc hiện hành.
