...
## Dependency bắt buộc
- `T0889` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review plugin install** theo BRD, SRS và kiến trúc hiện hành.
