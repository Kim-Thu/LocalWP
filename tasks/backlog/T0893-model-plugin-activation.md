...
## Dependency bắt buộc
- `T0892` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-plugin-activation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model plugin activation** theo BRD, SRS và kiến trúc hiện hành.
