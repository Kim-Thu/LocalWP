...
## Dependency bắt buộc
- `T0894` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-plugin-activation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test plugin activation** theo BRD, SRS và kiến trúc hiện hành.
