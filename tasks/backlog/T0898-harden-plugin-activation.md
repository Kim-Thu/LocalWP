# T0898 — Harden plugin activation
...
## Dependency bắt buộc
- `T0897` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-plugin-activation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden plugin activation** theo BRD, SRS và kiến trúc hiện hành.
