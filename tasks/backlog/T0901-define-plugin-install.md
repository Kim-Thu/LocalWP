...
## Dependency bắt buộc
- `T0900` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define plugin install** theo BRD, SRS và kiến trúc hiện hành.
