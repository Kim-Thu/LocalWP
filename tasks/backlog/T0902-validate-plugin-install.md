...
## Dependency bắt buộc
- `T0901` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate plugin install** theo BRD, SRS và kiến trúc hiện hành.
