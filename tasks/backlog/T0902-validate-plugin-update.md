...
## Branch bắt buộc
`feat/validate-plugin-update-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate plugin update** theo BRD, SRS và kiến trúc hiện hành.
