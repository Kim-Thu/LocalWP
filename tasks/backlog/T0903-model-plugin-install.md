...
## Dependency bắt buộc
- `T0902` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model plugin install** theo BRD, SRS và kiến trúc hiện hành.
