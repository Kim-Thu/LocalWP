...
## Dependency bắt buộc
- `T0904` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test plugin install** theo BRD, SRS và kiến trúc hiện hành.
