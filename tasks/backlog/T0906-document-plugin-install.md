...
## Dependency bắt buộc
- `T0905` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-plugin-install-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document plugin install** theo BRD, SRS và kiến trúc hiện hành.
