# T0917 — Integrate plugin activation
...
## Dependency bắt buộc
- `T0916` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-plugin-activation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate plugin activation** theo BRD, SRS và kiến trúc hiện hành.
