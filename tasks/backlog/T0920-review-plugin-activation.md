# T0920 — Review plugin activation
...
## Dependency bắt buộc
- `T0919` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-plugin-activation-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review plugin activation** theo BRD, SRS và kiến trúc hiện hành.
