...
## Dependency bắt buộc
- `T0920` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define backup request** theo BRD, SRS và kiến trúc hiện hành.
