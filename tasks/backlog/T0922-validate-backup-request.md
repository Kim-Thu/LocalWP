...
## Dependency bắt buộc
- `T0921` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate backup request** theo BRD, SRS và kiến trúc hiện hành.
