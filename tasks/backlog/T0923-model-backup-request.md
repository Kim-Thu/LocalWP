...
## Dependency bắt buộc
- `T0922` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model backup request** theo BRD, SRS và kiến trúc hiện hành.
