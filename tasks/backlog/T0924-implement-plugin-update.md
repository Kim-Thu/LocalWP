...
## Branch bắt buộc
`feat/implement-plugin-update-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement plugin update** theo BRD, SRS và kiến trúc hiện hành.
