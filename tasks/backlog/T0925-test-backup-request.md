...
## Dependency bắt buộc
- `T0924` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test backup request** theo BRD, SRS và kiến trúc hiện hành.
