...
## Dependency bắt buộc
- `T0932` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-database-dump-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model database dump** theo BRD, SRS và kiến trúc hiện hành.
