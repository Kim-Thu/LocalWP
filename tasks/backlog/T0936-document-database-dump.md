...
## Dependency bắt buộc
- `T0935` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-database-dump-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document database dump** theo BRD, SRS và kiến trúc hiện hành.
