...
## Dependency bắt buộc
- `T0936` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-database-dump-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate database dump** theo BRD, SRS và kiến trúc hiện hành.
