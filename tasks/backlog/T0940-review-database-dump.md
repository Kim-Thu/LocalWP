...
## Dependency bắt buộc
- `T0939` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-database-dump-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review database dump** theo BRD, SRS và kiến trúc hiện hành.
