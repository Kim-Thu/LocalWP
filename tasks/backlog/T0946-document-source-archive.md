...
## Dependency bắt buộc
- `T0945` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document source archive** theo BRD, SRS và kiến trúc hiện hành.
