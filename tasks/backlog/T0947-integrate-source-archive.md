# T0947 — Integrate source archive
...
## Dependency bắt buộc
- `T0946` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate source archive** theo BRD, SRS và kiến trúc hiện hành.
