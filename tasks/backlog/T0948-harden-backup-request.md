...
## Dependency bắt buộc
- `T0947` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden backup request** theo BRD, SRS và kiến trúc hiện hành.
