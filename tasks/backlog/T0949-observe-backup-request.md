...
## Dependency bắt buộc
- `T0948` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-backup-request-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe backup request** theo BRD, SRS và kiến trúc hiện hành.
