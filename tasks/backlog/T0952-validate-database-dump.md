...
## Branch bắt buộc
`feat/validate-database-dump-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate database dump** theo BRD, SRS và kiến trúc hiện hành.
