...
## Dependency bắt buộc
- `T0958` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe backup metadata** theo BRD, SRS và kiến trúc hiện hành.
