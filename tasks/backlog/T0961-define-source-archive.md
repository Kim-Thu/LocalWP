...
## Dependency bắt buộc
- `T0960` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define source archive** theo BRD, SRS và kiến trúc hiện hành.
