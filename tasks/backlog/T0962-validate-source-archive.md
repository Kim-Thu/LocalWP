...
## Dependency bắt buộc
- `T0961` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate source archive** theo BRD, SRS và kiến trúc hiện hành.
