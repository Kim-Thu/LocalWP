...
## Dependency bắt buộc
- `T0962` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-integrity-hash-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model integrity hash** theo BRD, SRS và kiến trúc hiện hành.
