...
## Dependency bắt buộc
- `T0964` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test source archive** theo BRD, SRS và kiến trúc hiện hành.
