...
## Dependency bắt buộc
- `T0967` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden source archive** theo BRD, SRS và kiến trúc hiện hành.
