...
## Branch bắt buộc
`feat/observe-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe source archive** theo BRD, SRS và kiến trúc hiện hành.
