...
## Dependency bắt buộc
- `T0969` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-source-archive-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review source archive** theo BRD, SRS và kiến trúc hiện hành.
