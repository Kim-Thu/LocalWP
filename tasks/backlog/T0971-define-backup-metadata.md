...
## Dependency bắt buộc
- `T0970` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define backup metadata** theo BRD, SRS và kiến trúc hiện hành.
