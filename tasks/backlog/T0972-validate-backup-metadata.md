# T0972 — Validate backup metadata
...
## Dependency bắt buộc
- `T0971` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate backup metadata** theo BRD, SRS và kiến trúc hiện hành.
