...
## Dependency bắt buộc
- `T0974` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-backup-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test backup metadata** theo BRD, SRS và kiến trúc hiện hành.
