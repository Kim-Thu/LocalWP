# T0977 — Integrate backup listing
...
## Branch bắt buộc
`feat/integrate-backup-listing-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate backup listing** theo BRD, SRS và kiến trúc hiện hành.
