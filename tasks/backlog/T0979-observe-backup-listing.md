...
## Branch bắt buộc
`feat/observe-backup-listing-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe backup listing** theo BRD, SRS và kiến trúc hiện hành.
