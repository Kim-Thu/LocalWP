...
## Dependency bắt buộc
- `T0980` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define backup deletion** theo BRD, SRS và kiến trúc hiện hành.
