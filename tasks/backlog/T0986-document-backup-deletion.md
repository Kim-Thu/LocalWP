# T0986 — Document backup deletion
...
## Dependency bắt buộc
- `T0985` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document backup deletion** theo BRD, SRS và kiến trúc hiện hành.
