...
## Branch bắt buộc
`feat/document-integrity-hash-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document integrity hash** theo BRD, SRS và kiến trúc hiện hành.
