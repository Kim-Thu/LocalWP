# T0987 — Integrate backup deletion
...
## Dependency bắt buộc
- `T0986` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate backup deletion** theo BRD, SRS và kiến trúc hiện hành.
