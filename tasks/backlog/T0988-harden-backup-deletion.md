...
## Dependency bắt buộc
- `T0987` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden backup deletion** theo BRD, SRS và kiến trúc hiện hành.
