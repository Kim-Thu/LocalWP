...
## Dependency bắt buộc
- `T0989` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review backup deletion** theo BRD, SRS và kiến trúc hiện hành.
