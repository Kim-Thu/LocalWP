...
## Dependency bắt buộc
- `T0991` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-backup-listing-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate backup listing** theo BRD, SRS và kiến trúc hiện hành.
