# T0994 — Implement backup listing
...
## Dependency bắt buộc
- `T0993` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-backup-listing-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement backup listing** theo BRD, SRS và kiến trúc hiện hành.
