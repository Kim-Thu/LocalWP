...
## Dependency bắt buộc
- `T1002` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model backup deletion** theo BRD, SRS và kiến trúc hiện hành.
