# T1004 — Implement backup deletion
...
## Dependency bắt buộc
- `T1003` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement backup deletion** theo BRD, SRS và kiến trúc hiện hành.
