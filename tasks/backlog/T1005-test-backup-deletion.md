...
## Dependency bắt buộc
- `T1004` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test backup deletion** theo BRD, SRS và kiến trúc hiện hành.
