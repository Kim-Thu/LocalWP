...
## Dependency bắt buộc
- `T1008` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-backup-deletion-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe backup deletion** theo BRD, SRS và kiến trúc hiện hành.
