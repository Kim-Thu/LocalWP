# T1012 — Validate database snapshot
...
## Dependency bắt buộc
- `T1011` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-database-snapshot-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate database snapshot** theo BRD, SRS và kiến trúc hiện hành.
