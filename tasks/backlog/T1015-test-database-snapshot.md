...
## Dependency bắt buộc
- `T1014` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-database-snapshot-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test database snapshot** theo BRD, SRS và kiến trúc hiện hành.
