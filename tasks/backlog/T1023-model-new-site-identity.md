...
## Dependency bắt buộc
- `T1022` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-new-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model new site identity** theo BRD, SRS và kiến trúc hiện hành.
