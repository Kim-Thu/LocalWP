...
## Dependency bắt buộc
- `T1024` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-new-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test new site identity** theo BRD, SRS và kiến trúc hiện hành.
