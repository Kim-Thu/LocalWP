# T1028 — Harden new site identity
...
## Dependency bắt buộc
- `T1027` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-new-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden new site identity** theo BRD, SRS và kiến trúc hiện hành.
