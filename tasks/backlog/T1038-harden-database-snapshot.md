# T1038 — Harden database snapshot
...
## Dependency bắt buộc
- `T1037` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-database-snapshot-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden database snapshot** theo BRD, SRS và kiến trúc hiện hành.
