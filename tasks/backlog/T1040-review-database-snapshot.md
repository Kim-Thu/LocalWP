# T1040 — Review database snapshot
...
## Dependency bắt buộc
- `T1039` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-database-snapshot-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review database snapshot** theo BRD, SRS và kiến trúc hiện hành.
