# T1047 — Integrate new site identity
...
## Dependency bắt buộc
- `T1046` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-new-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate new site identity** theo BRD, SRS và kiến trúc hiện hành.
