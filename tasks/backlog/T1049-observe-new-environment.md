...
## Branch bắt buộc
`feat/observe-new-environment-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe new environment** theo BRD, SRS và kiến trúc hiện hành.
