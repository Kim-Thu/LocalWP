# T1049 — Observe new site identity
...
## Dependency bắt buộc
- `T1048` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-new-site-identity-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe new site identity** theo BRD, SRS và kiến trúc hiện hành.
