...
## Dependency bắt buộc
- `T1050` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-blueprint-schema-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define blueprint schema** theo BRD, SRS và kiến trúc hiện hành.
