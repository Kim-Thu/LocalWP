...
## Dependency bắt buộc
- `T1059` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-blueprint-schema-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review blueprint schema** theo BRD, SRS và kiến trúc hiện hành.
