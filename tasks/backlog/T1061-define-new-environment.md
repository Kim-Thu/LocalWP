...
## Branch bắt buộc
`feat/define-new-environment-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define new environment** theo BRD, SRS và kiến trúc hiện hành.
