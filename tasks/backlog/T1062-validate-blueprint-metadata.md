# T1062 — Validate blueprint metadata
...
## Dependency bắt buộc
- `T1061` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-blueprint-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate blueprint metadata** theo BRD, SRS và kiến trúc hiện hành.
