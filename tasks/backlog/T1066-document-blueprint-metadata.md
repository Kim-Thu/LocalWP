# T1066 — Document blueprint metadata
...
## Dependency bắt buộc
- `T1065` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-blueprint-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document blueprint metadata** theo BRD, SRS và kiến trúc hiện hành.
