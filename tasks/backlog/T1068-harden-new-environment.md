...
## Branch bắt buộc
`feat/harden-new-environment-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden new environment** theo BRD, SRS và kiến trúc hiện hành.
