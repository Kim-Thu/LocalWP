...
## Branch bắt buộc
`feat/harden-blueprint-schema-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden blueprint schema** theo BRD, SRS và kiến trúc hiện hành.
