...
## Dependency bắt buộc
- `T1077` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-config-blueprint-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden config blueprint** theo BRD, SRS và kiến trúc hiện hành.
