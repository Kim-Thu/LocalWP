# T1081 — Define blueprint metadata
...
## Dependency bắt buộc
- `T1080` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-blueprint-metadata-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define blueprint metadata** theo BRD, SRS và kiến trúc hiện hành.
