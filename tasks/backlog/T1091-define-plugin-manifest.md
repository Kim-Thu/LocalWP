...
## Branch bắt buộc
`feat/define-plugin-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define plugin manifest** theo BRD, SRS và kiến trúc hiện hành.
