# T1092 — Validate plugin manifest
...
## Branch bắt buộc
`feat/validate-plugin-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate plugin manifest** theo BRD, SRS và kiến trúc hiện hành.
