...
## Dependency bắt buộc
- `T1092` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-config-blueprint-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model config blueprint** theo BRD, SRS và kiến trúc hiện hành.
