...
## Branch bắt buộc
`feat/harden-plugin-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden plugin manifest** theo BRD, SRS và kiến trúc hiện hành.
