...
## Branch bắt buộc
`feat/observe-plugin-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe plugin manifest** theo BRD, SRS và kiến trúc hiện hành.
