...
## Dependency bắt buộc
- `T1100` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-theme-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define theme manifest** theo BRD, SRS và kiến trúc hiện hành.
