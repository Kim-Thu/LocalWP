...
## Dependency bắt buộc
- `T1102` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-theme-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model theme manifest** theo BRD, SRS và kiến trúc hiện hành.
