...
## Dependency bắt buộc
- `T1104` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-full-blueprint-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test full blueprint** theo BRD, SRS và kiến trúc hiện hành.
