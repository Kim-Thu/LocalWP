...
## Dependency bắt buộc
- `T1107` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-theme-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden theme manifest** theo BRD, SRS và kiến trúc hiện hành.
