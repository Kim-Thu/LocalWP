...
## Dependency bắt buộc
- `T1110` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
