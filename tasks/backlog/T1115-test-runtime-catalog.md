...
## Dependency bắt buộc
- `T1114` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
