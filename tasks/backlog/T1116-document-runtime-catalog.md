# T1116 — Document runtime catalog
...
## Dependency bắt buộc
- `T1115` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
