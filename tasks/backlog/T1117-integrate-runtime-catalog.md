# T1117 — Integrate runtime catalog
...
## Dependency bắt buộc
- `T1116` phải hoàn thành và merge.

## Branch bắt buộc
`feat/integrate-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
