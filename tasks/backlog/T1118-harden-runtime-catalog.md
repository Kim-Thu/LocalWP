...
## Dependency bắt buộc
- `T1117` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
