...
## Dependency bắt buộc
- `T1119` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-plugin-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review plugin manifest** theo BRD, SRS và kiến trúc hiện hành.
