# T1122 — Validate compatibility matrix
...
## Dependency bắt buộc
- `T1121` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
