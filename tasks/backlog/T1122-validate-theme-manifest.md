...
## Branch bắt buộc
`feat/validate-theme-manifest-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate theme manifest** theo BRD, SRS và kiến trúc hiện hành.
