# T1129 — Observe compatibility matrix
...
## Dependency bắt buộc
- `T1128` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
