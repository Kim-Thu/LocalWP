...
## Branch bắt buộc
`feat/validate-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
