# T1132 — Validate runtime catalog
...
## Dependency bắt buộc
- `T1131` phải hoàn thành và merge.

## Branch bắt buộc
`feat/validate-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
