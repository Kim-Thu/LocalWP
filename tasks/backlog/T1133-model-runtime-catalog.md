...
## Dependency bắt buộc
- `T1132` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
