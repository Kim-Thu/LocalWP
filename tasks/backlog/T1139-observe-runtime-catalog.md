...
## Dependency bắt buộc
- `T1138` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
