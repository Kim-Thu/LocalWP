...
## Dependency bắt buộc
- `T1139` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-runtime-catalog-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review runtime catalog** theo BRD, SRS và kiến trúc hiện hành.
