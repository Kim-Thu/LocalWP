# T1141 — Define compatibility matrix
...
## Dependency bắt buộc
- `T1140` phải hoàn thành và merge.

## Branch bắt buộc
`feat/define-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
