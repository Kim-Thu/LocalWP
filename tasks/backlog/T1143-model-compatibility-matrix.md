# T1143 — Model compatibility matrix
...
## Dependency bắt buộc
- `T1142` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
