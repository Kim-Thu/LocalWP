# T1144 — Implement compatibility matrix
...
## Dependency bắt buộc
- `T1143` phải hoàn thành và merge.

## Branch bắt buộc
`feat/implement-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
