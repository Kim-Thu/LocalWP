# T1148 — Harden compatibility matrix
...
## Dependency bắt buộc
- `T1147` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-compatibility-matrix-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden compatibility matrix** theo BRD, SRS và kiến trúc hiện hành.
