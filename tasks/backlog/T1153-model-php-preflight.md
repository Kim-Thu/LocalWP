...
## Dependency bắt buộc
- `T1152` phải hoàn thành và merge.

## Branch bắt buộc
`feat/model-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
