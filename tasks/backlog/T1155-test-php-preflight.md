...
## Dependency bắt buộc
- `T1154` phải hoàn thành và merge.

## Branch bắt buộc
`feat/test-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
