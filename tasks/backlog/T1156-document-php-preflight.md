...
## Dependency bắt buộc
- `T1155` phải hoàn thành và merge.

## Branch bắt buộc
`feat/document-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
