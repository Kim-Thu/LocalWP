...
## Dependency bắt buộc
- `T1157` phải hoàn thành và merge.

## Branch bắt buộc
`feat/harden-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
