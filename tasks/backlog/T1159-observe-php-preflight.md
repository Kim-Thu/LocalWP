...
## Dependency bắt buộc
- `T1158` phải hoàn thành và merge.

## Branch bắt buộc
`feat/observe-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
