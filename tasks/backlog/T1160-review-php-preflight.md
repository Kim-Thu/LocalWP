...
## Dependency bắt buộc
- `T1159` phải hoàn thành và merge.

## Branch bắt buộc
`feat/review-php-preflight-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review PHP preflight** theo BRD, SRS và kiến trúc hiện hành.
