...
## Dependency bắt buộc
- `T1161` phải hoàn thành và merge.

## Branch bắt buộc
`fix/validate-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate port conflict** theo BRD, SRS và kiến trúc hiện hành.
