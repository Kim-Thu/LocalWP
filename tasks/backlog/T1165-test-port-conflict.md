...
## Dependency bắt buộc
- `T1164` phải hoàn thành và merge.

## Branch bắt buộc
`fix/test-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test port conflict** theo BRD, SRS và kiến trúc hiện hành.
