...
## Dependency bắt buộc
- `T1165` phải hoàn thành và merge.

## Branch bắt buộc
`fix/document-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document port conflict** theo BRD, SRS và kiến trúc hiện hành.
