...
## Dependency bắt buộc
- `T1167` phải hoàn thành và merge.

## Branch bắt buộc
`fix/harden-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden port conflict** theo BRD, SRS và kiến trúc hiện hành.
