...
## Dependency bắt buộc
- `T1180` phải hoàn thành và merge.

## Branch bắt buộc
`fix/define-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define missing config** theo BRD, SRS và kiến trúc hiện hành.
