...
## Dependency bắt buộc
- `T1181` phải hoàn thành và merge.

## Branch bắt buộc
`fix/validate-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate missing config** theo BRD, SRS và kiến trúc hiện hành.
