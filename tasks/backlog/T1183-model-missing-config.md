...
## Dependency bắt buộc
- `T1182` phải hoàn thành và merge.

## Branch bắt buộc
`fix/model-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model missing config** theo BRD, SRS và kiến trúc hiện hành.
