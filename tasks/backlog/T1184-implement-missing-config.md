# T1184 — Implement missing config
...
## Dependency bắt buộc
- `T1183` phải hoàn thành và merge.

## Branch bắt buộc
`fix/implement-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement missing config** theo BRD, SRS và kiến trúc hiện hành.
