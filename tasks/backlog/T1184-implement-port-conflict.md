...
## Branch bắt buộc
`fix/implement-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement port conflict** theo BRD, SRS và kiến trúc hiện hành.
