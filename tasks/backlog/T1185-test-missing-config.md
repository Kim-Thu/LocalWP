...
## Dependency bắt buộc
- `T1184` phải hoàn thành và merge.

## Branch bắt buộc
`fix/test-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test missing config** theo BRD, SRS và kiến trúc hiện hành.
