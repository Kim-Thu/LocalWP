# T1187 — Integrate missing config
...
## Dependency bắt buộc
- `T1186` phải hoàn thành và merge.

## Branch bắt buộc
`fix/integrate-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate missing config** theo BRD, SRS và kiến trúc hiện hành.
