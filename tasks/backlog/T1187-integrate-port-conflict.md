...
## Branch bắt buộc
`fix/integrate-port-conflict-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate port conflict** theo BRD, SRS và kiến trúc hiện hành.
