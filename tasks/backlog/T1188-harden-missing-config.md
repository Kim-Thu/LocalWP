...
## Dependency bắt buộc
- `T1187` phải hoàn thành và merge.

## Branch bắt buộc
`fix/harden-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden missing config** theo BRD, SRS và kiến trúc hiện hành.
