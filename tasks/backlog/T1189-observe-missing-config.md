...
## Dependency bắt buộc
- `T1188` phải hoàn thành và merge.

## Branch bắt buộc
`fix/observe-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe missing config** theo BRD, SRS và kiến trúc hiện hành.
