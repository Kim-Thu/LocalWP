...
## Dependency bắt buộc
- `T1189` phải hoàn thành và merge.

## Branch bắt buộc
`fix/review-missing-config-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review missing config** theo BRD, SRS và kiến trúc hiện hành.
