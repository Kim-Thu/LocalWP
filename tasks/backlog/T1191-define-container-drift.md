...
## Dependency bắt buộc
- `T1190` phải hoàn thành và merge.

## Branch bắt buộc
`fix/define-container-drift-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define container drift** theo BRD, SRS và kiến trúc hiện hành.
