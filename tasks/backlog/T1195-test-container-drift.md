...
## Dependency bắt buộc
- `T1194` phải hoàn thành và merge.

## Branch bắt buộc
`fix/test-container-drift-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test container drift** theo BRD, SRS và kiến trúc hiện hành.
