# T1196 — Document windows publish
...
## Branch bắt buộc
`ci/document-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document Windows publish** theo BRD, SRS và kiến trúc hiện hành.
