...
## Dependency bắt buộc
- `T1197` phải hoàn thành và merge.

## Branch bắt buộc
`fix/harden-container-drift-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden container drift** theo BRD, SRS và kiến trúc hiện hành.
