...
## Dependency bắt buộc
- `T1198` phải hoàn thành và merge.

## Branch bắt buộc
`fix/observe-container-drift-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe container drift** theo BRD, SRS và kiến trúc hiện hành.
