...
## Branch bắt buộc
`ci/review-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **review Windows publish** theo BRD, SRS và kiến trúc hiện hành.
