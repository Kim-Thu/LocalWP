# T1201 — Define self-contained build
...
## Dependency bắt buộc
- `T1200` phải hoàn thành và merge.

## Branch bắt buộc
`ci/define-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define self-contained build** theo BRD, SRS và kiến trúc hiện hành.
