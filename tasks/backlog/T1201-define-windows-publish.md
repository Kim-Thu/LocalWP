...
## Branch bắt buộc
`ci/define-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **define Windows publish** theo BRD, SRS và kiến trúc hiện hành.
