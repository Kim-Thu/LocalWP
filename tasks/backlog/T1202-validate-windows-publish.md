# T1202 — Validate windows publish
...
## Branch bắt buộc
`ci/validate-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate Windows publish** theo BRD, SRS và kiến trúc hiện hành.
