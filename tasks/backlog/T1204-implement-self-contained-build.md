# T1204 — Implement self-contained build
...
## Dependency bắt buộc
- `T1203` phải hoàn thành và merge.

## Branch bắt buộc
`ci/implement-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement self-contained build** theo BRD, SRS và kiến trúc hiện hành.
