# T1204 — Implement windows publish
...
## Branch bắt buộc
`ci/implement-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **implement Windows publish** theo BRD, SRS và kiến trúc hiện hành.
