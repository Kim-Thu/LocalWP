# T1206 — Document self-contained build
...
## Dependency bắt buộc
- `T1205` phải hoàn thành và merge.

## Branch bắt buộc
`ci/document-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **document self-contained build** theo BRD, SRS và kiến trúc hiện hành.
