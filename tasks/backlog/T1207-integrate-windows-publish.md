# T1207 — Integrate windows publish
...
## Branch bắt buộc
`ci/integrate-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate Windows publish** theo BRD, SRS và kiến trúc hiện hành.
