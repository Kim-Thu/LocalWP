...
## Branch bắt buộc
`ci/harden-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden Windows publish** theo BRD, SRS và kiến trúc hiện hành.
