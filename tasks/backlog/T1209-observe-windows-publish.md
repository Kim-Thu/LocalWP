...
## Branch bắt buộc
`ci/observe-windows-publish-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **observe Windows publish** theo BRD, SRS và kiến trúc hiện hành.
