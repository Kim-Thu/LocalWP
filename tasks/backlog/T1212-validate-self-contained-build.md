# T1212 — Validate self-contained build
...
## Dependency bắt buộc
- `T1211` phải hoàn thành và merge.

## Branch bắt buộc
`ci/validate-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **validate self-contained build** theo BRD, SRS và kiến trúc hiện hành.
