# T1213 — Model self-contained build
...
## Dependency bắt buộc
- `T1212` phải hoàn thành và merge.

## Branch bắt buộc
`ci/model-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **model self-contained build** theo BRD, SRS và kiến trúc hiện hành.
