# T1215 — Test self-contained build
...
## Dependency bắt buộc
- `T1214` phải hoàn thành và merge.

## Branch bắt buộc
`ci/test-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **test self-contained build** theo BRD, SRS và kiến trúc hiện hành.
