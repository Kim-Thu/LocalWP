# T1217 — Integrate self-contained build
...
## Dependency bắt buộc
- `T1216` phải hoàn thành và merge.

## Branch bắt buộc
`ci/integrate-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **integrate self-contained build** theo BRD, SRS và kiến trúc hiện hành.
