# T1218 — Harden self-contained build
...
## Dependency bắt buộc
- `T1217` phải hoàn thành và merge.

## Branch bắt buộc
`ci/harden-self-contained-build-yyyyMMdd-HHmm`

## Mục tiêu
Hoàn thành duy nhất phần **harden self-contained build** theo BRD, SRS và kiến trúc hiện hành.
